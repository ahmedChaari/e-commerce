        ...
        <div class="product-details">
            ...
            <div class="col-lg-6 col-lg-offset-1 col-md-6 col-md-offset-1 col-sm-6 col-sm-offset-1 col-xs-12 col-xs-offset-0">
                <div class="product-details-info">
                    ...
                    <h3 class="product-details-info-title">{{ $post->name }}</h3>
                    <p class="product-details-info-text">{{ $post->description }}</p>
                    ...
                    <form action="{{ route('cart.add') }}" method="post">
                        ...
                        <div class="quantity">
                            ...
                            name="qty" type="text" value="2">
                            <a href="#" class="quantity-plus quantity-plus-d">+</a>
                        </div>
                            <input type="hidden" name="pdt_id" value="{{ $post->id }}">
                            
                        <button href="19_cart.html" class="btn btn-medium btn--primary bay12">
